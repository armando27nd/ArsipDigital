...
class ArsipExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
    ...
    // 1. Constructor diubah untuk menerima semua parameter dari Controller
    ...
    */
    ...
    {
        // Menggunakan data yang sudah dikirim dari controller
        return $this->arsip;
    }
    ...
    {
        return [
            // Header tabel sekarang ada di baris ke-5
            5 => ['font' => ['bold' => true]],
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Membuat judul dinamis berdasarkan jenis surat
                $judul = 'LAPORAN ARSIP';
                ...
                // =================================================================
                // PERUBAHAN UTAMA: Membuat judul berdasarkan filter & dalam Bahasa Indonesia
                // =================================================================
                Carbon::setLocale('id');

                $bulanTahun = 'PERIODE KESELURUHAN'; // Judul default jika tidak ada filter
